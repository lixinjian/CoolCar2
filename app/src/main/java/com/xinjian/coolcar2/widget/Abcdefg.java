package com.xinjian.coolcar2.widget;
...
public class Abcdefg extends View {
    ...
    public Abcdefg(Context context) {
        this(context, null);
    }

    public Abcdefg(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Abcdefg(Context context, AttributeSet attrs, int defStyleAttr) {
